                                                ...
                                                <div class="col-12 col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="number" class="form-control form-label-group char-textarea" name="reduction" placeholder="Ex: 50% (Sans le %)" required data-validation-required-message="Description requise"></input>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="controls">
