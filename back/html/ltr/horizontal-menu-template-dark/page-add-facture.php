...
<head>
    ...
    <title>Ajout de facture - Speed-Cash.fr</title>
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    <div class="tab-pane active fade show" id="account" aria-labelledby="account-tab" role="tabpanel">
                                        ...
                                        <form role="form" method="post" action="../../../php/addFacture.php" enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="col-12 col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="text" class="form-control" name="ref_article" placeholder="Ex: RF#FR100302" required data-validation-required-message="Référence article requise">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label>Commande_ID</label>
                                                            <input type="number" class="form-control form-label-group char-textarea" name="commande_id" placeholder="Ex: 123" required data-validation-required-message="Commande_ID requis"></input>
                                                        </div>
                                                    </div>
                                            </div>
