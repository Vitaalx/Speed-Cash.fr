...
$q = $conn->query("SELECT * FROM produits WHERE id = '".$_GET['id']."' AND type='produit'");
...
<head>
    ...
    <title>Changer un produit de dépôt - Speed-Cash.fr</title>
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    <div class="tab-pane active fade show" id="account" aria-labelledby="account-tab" role="tabpanel">
                                        ...
                                        <form role="form" method="post" action="../../../php/modifProdDepot.php" enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label>Changer de dépôt</label>
                                                            <select class="form-control" id="depot" name="depot">
                                                                <option selected="selected">Changer vers dépôt n°..</option>
