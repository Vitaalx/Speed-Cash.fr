...
function deleteCus(){
    ...
    q2.open("POST", "./php/deleteCusA.php"); 
...
function supprProd(){
    ...
    q15.open("POST", "./php/supprProdA.php");
...
function modifCus(){
    ...
    if(checkedname.checked != null){
        ...
        q5.open("POST", "../../../php/modifCusA.php");
        q5.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
        q5.send(`id=${idv}&name=${checkedname.value}`);
    }
    if(checkedsname.checked != null){
        ...
        q6.open("POST", "../../../php/modifCusA.php");
        q6.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
        q6.send(`id=${idv}&sname=${checkedsname.value}`);
    }
    if(checkedmail.checked != null){
        ...
        q7.open("POST", "../../../php/modifCusA.php");
        q7.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
        q7.send(`id=${idv}&mail=${checkedmail.value}`);
    }
    if(checkednat.checked != null){
        ...
        q8.open("POST", "../../../php/modifCusA.php");
        q8.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
        q8.send(`id=${idv}&nat=${checkednat.value}`);
    }
    if(checkedage.checked != null){
        ...
        q9.open("POST", "../../../php/modifCusA.php");
        q9.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
        q9.send(`id=${idv}&age=${checkedage.value}`);
    }
    if(checkedrole.checked != null){
        ...
        q10.open("POST", "../../../php/modifCusA.php");
        q10.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
        q10.send(`id=${idv}&role=${checkedrole.value}`);
    }   
}
...
function modifProd(){
    ...
    if(checkednamep.checked == true){
        ...
        q11.open("POST", "../../../php/modifProdA.php");
    ...
    if(checkedcatp.checked == true){
        ...
        q12.open("POST", "../../../php/modifProdA.php");
    ...
    if(checkbrandp.checked == true){
        ...
        q13.open("POST", "../../../php/modifProdA.php");
    ...
    if(checkedpricep.checked == true){
        ...
        q14.open("POST", "../../../php/modifProdA.php");
