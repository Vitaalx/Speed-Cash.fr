...
foreach($responses as $response) {
  ...
  echo "<td>" . $response['nb_siret'] . "</td>";
  echo "<td>" . $response['type_societe'] . "</td>";
  echo "<td>" . $response['tel'] . "</td>";
  echo '<td><a href="page-entreprise-edit.php?id=' . $response['id'] . '">' . $response['nom_entreprise'] . '</a></td>';
  echo "<td>" . $response['adresse_entreprise'] . "</td>";
  ...
  echo '<td><a href="../../../html/ltr/horizontal-menu-template-dark/page-entreprise-edit.php?id='.$response['id'].'"><i class="bx bx-edit-alt"></i></a><a href="../../../php/deleteCompany.php?id=' . $response['id'] . '"><i class="bx bxs-trash" onclick="return confirmDelete()"></i></a></td>';
  echo "</tr>";
}
