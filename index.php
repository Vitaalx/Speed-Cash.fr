...
<html lang="fr" dir="ltr">
    ...
    <div class="modal-container">
                ...
                <div class="form-box sign-in-box">
                    ...
                    <div class="login-options">
                        ...
                        <div class="other-login">
                            ...
                            <a href=""><img src="./images/facebook.png" alt="Se connecter avec Facebook"></a>
                            <a href=""><img src="./images/apple.png" alt="Se connecter avec Apple"></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-container sign-up-form">
                ...
                <div class="form-box sign-up-box">
                    ...
                    <form role="form" id="inscriptionForm" enctype="multipart/form-data">
                        ...
                        <p style="font-size: 0.65em; margin-bottom: 5%; color: #2DA771;">* Votre mot de passe doit contenir au moins une minuscule, une majuscule et un chiffre !</p>
                        <div class="field">
                            <i class="uil uil-lock-access"></i>
                            <input type="password" placeholder="Confirmer mot de passe" id="confirmpass" required>
                        </div>
                        <div class="field">
                            <i class="uil uil-lock-alt"></i>
        ...
        <p class="marketing-phrase">
            Avec une intégration et un portefeuille numérique bien construit, contrôlez votre propre carte et répertoriez tous vos paiements à payer.
            Définissez votre propre clé de code pour effectuer tous les paiements en une seule action d'approbation.
        </p>
        ...
        <h5 class="details-wallet">
            Trouver plus de détails et en savoir plus sur le portefeuille numérique <a href="https://fr.wikipedia.org/wiki/Porte-monnaie_%C3%A9lectronique">içi</a>
        </h5>

        <h5 class="approuved-byUser">
            Approuvé par plus de 40 millions d'utilisateurs
        </h5>

        <img class="appstore-icon" src="./icons/appstore-icon.svg" alt="Apple Store">
        <img class="playstore-icon" src="icons/playstore-icon.svg" alt="Google Play Store">
