...
<html lang="fr">
<head>
    <title>Animation Paiement - Speed-Cash.fr</title>
    <meta charset="utf-8">
...
<div class="terminal" id="terminal" style="position: absolute;top: 18%; left: 35%;display: none;">
    <div class="terminal-content">
        <div class="terminal-line" style="position: absolute; top: 35%; left: 40%; font-size: 24px;">

        </div>
        <button data-key="97" class="terminal-button bouton" style="position: absolute; top: 58%; left: 35%; width: 58px; padding: 10px; border: 1.6px inset white; border-radius: 0.5rem; background: #989C9D;">1</button>
        <button data-key="98" class="terminal-button bouton" style="position: absolute; top: 58%; left: 46%; width: 58px; padding: 10px; border: 1.6px inset white; border-radius: 0.5rem; background: #989C9D;">2</button>
        <button data-key="99" class="terminal-button bouton" style="position: absolute; top: 58%; left: 57%; width: 58px; padding: 10px; border: 1.6px inset white; border-radius: 0.5rem; background: #989C9D;">3</button>
        <button data-key="100" class="terminal-button bouton" style="position: absolute; top: 65%; left: 35%; width: 58px; padding: 10px; border: 1.6px inset white; border-radius: 0.5rem; background: #989C9D;">4</button>
        <button data-key="101" class="terminal-button bouton" style="position: absolute; top: 65%; left: 46%; width: 58px; padding: 10px; border: 1.6px inset white; border-radius: 0.5rem; background: #989C9D;">5</button>
        <button data-key="102" class="terminal-button bouton" style="position: absolute; top: 65%; left: 57%; width: 58px; padding: 10px; border: 1.6px inset white; border-radius: 0.5rem; background: #989C9D;">6</button>
        <button data-key="103" class="terminal-button bouton" style="position: absolute; top: 72%; left: 35%; width: 58px; padding: 10px; border: 1.6px inset white; border-radius: 0.5rem; background: #989C9D;">7</button>
        <button data-key="104" class="terminal-button bouton" style="position: absolute; top: 72%; left: 46%; width: 58px; padding: 10px; border: 1.6px inset white; border-radius: 0.5rem; background: #989C9D;">8</button>
        <button data-key="105" class="terminal-button bouton" style="position: absolute; top: 72%; left: 57%; width: 58px; padding: 10px; border: 1.6px inset white; border-radius: 0.5rem; background: #989C9D;">9</button>
        <button data-key="96" class="terminal-button bouton" style="position: absolute; top: 79%; left: 46%; width: 58px; padding: 10px; border: 1.6px inset white; border-radius: 0.5rem; background: #989C9D;">0</button>
        <button data-key="27" class="terminal-button bouton" style="position: absolute; top: 86%; left: 35%; width: 58px; padding: 10px; border: 1.6px inset white; border-radius: 0.5rem; background: red;">Cancel</button>
        <button data-key="8" class="terminal-button bouton" style="position: absolute; top: 86%; left: 46%; width: 58px; padding: 10px; border: 1.6px inset white; border-radius: 0.5rem; background: yellow;">Clear</button>
        <button data-key="13" class="terminal-button bouton" style="position: absolute; top: 86%; left: 57%; width: 58px; padding: 10px; border: 1.6px inset white; border-radius: 0.5rem; background: green;">Enter</button>
...
<script type="module">
    ...
    function animate() {
        ...
        if (camera.position.x < 1 && camera.position.z < 29) {
            ...
            // On enlève la possiblité de déplacer la caméra avec le FirstPersonControls
