...
<body>
  <div class="container">
    ...
    <a class="a-french-flag" href="./paymentCart.php" ><img style="margin-bottom: 1%;" class="french-flag" src="images/drapeau-france.png" width="55" height="30" alt="Drapeau Français"></a>
    <a class="a-english-flag" href="./paymentCart.php?lang=1" ><img style="margin-bottom: 1%;" class="english-flag" src="images/drapeau-anglais.png" width="55" height="30" alt="Drapeau Anglais"></a>
